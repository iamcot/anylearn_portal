...
<div class="row mb-5">
    <div class="col-xs-12 col-md-8">
        ...
        <p class="small text-secondary"><i class="fa fa-clock"></i> Cập nhật lúc {{ date('d/m/Y', strtotime($knowledge->updated_at)) }}</p>
        {!! $knowledge->content !!}
        <hr>
        <div class="small">Bài viết này hữu ích cho bạn ? <a href="#" class=" text-secondary p-2"><i  class="fa fa-thumbs-up"></i></a> <a href="#" class=" text-secondary p-2"><i  class="fa fa-thumbs-down"></i></a></div>
    </div>
