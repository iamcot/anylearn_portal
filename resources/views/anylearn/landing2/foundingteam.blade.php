                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        ...
                        <div class="card-footer border-0 text-center">
                            ...
                            <span class="fs-6">Founder & CEO anyLEARN</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border-0">
                        ...
                        <div class="card-footer border-0 text-center">
                            <div class="fs-5 fw-bold">Ms. Tôn Thị Quỳnh Như</div>
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card border-0">
                        <div class="card-body">
                            <img src="/cdn/anylearn/img/mrThang.png" alt="">
                            <img class="bg-img" src="/cdn/anylearn/img/mrHuyen.jpg" width="288" alt="">
                        </div>
                        <div class="card-footer border-0 text-center">
                            <div class="fs-5 fw-bold">Mr. Lê Thế Huyên</div>
                            <span class="fs-6">Legal Team Leader</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border-0">
                        <div class="card-body">
                            <img src="/cdn/anylearn/img/mrThang.png" alt="">
                            <img class="bg-img" src="/cdn/anylearn/img/msDung.jpg" width="288" alt="">
                        </div>
                        <div class="card-footer border-0 text-center">
                            <div class="fs-5 fw-bold">Ms. Nguyễn Thị Viên Dung</div>
                            <span class="fs-6">Head of Partner Relationship</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
