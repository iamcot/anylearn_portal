...
<div class="card mb-5 border-left-success shadow">
    ...
    <div class="card-body p-0">
        <h5 class="p-3 text-success font-weight-bold">Đơn hàng đã được thanh toán và xác nhận thành công. Bạn hãy sử dụng APP để cập nhật lịch học một cách nhanh nhất nhé.</h5>
