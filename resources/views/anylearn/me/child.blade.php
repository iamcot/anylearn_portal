...
<button class="btn btn-success rounded rounded-pill btn-sm my-2 my-sm-0 ml-2 " data-bs-toggle="modal" data-bs-target="#exampleModal">Tạo Tài khoản</button>
@endsection
@section('body')
            ...
            <tbody>
                ...
                <tr>
                    <form action="" method="get">
                        ...
                        <td class="text-right"> <button class="btn btn-primary btn-sm" id="{{ $row->id }}" name="childedit" value="{{ $row->id }}">Chi tiết</button></td>
                    </form>
                </tr>
                @endforeach
