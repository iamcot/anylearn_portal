    ...
    <div class="card shadow">
        <div class="card-body">
            <div class="">
                ...
                <div class="form-group row">
                    <label for="introduce" class="col-md-2 col-form-label text-md-right @error('content') is-invalid @enderror">{{ __('Giới thiệu ngắn') }}</label>
                    <div class="col-md-8">
                        <textarea class="form-control" id="introduce" name="introduce">{!! old('introduce', !empty($user) ? $user->introduce : '') !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="editor" class="col-md-2 col-form-label text-md-right @error('content') is-invalid @enderror">{{ __('Thông tin giới thiệu') }}</label>
                    <div class="col-md-10">
