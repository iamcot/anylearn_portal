...
@section('body')
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="">
                                    ...
                                    <div class="row">
                                        <div class="panel">
                                            <div class="cover-photo">
                                                ...
                                                @else
                                                    <div class="fb-timeline-img">
                                                        <img src="http://anylearn.vn/cdn/anylearn/img/logo-color.svg"
                                                            alt="">
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="panel-body">
                                                @if (auth()->user()->image != null)
                                                    ...
                                                    <h2 style="margin-top:5px"><a
                                                            class="text-black">{{ Auth::user()->name }}</a></h2>
                                                @else
                                                    <div class="profile-thumb">
                                                        <img src="http://anylearn.vn/cdn/anylearn/img/logo-color.svg"
                                                            alt="">
                            ...
                            <div class="form-group row">
                                <label for="title"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Ngày sinh*') }}</label>
                                <div class="col-md-8">
                                    <input id="title" type="date"
                                        class="form-control @error('dob') is-invalid @enderror" name="dob"
                                        value="{{ old('dob', !empty($user) ? $user->dob : '') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Giới tính') }}</label>
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="male" name="sex"
                                                    id="sex" <?php if (empty($user->sex) || $user->sex == 'male') {
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="female" name="sex"
                                                    id="sex" <?php if (!empty($user->sex) && $user->sex == 'female') {
                                                        echo "checked='checked'";
                                                    } ?>>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="other" name="sex"
                                                    id="sex" <?php if (!empty($user->sex) && $user->sex == 'other') {
                                                        echo "checked='checked'";
                                                    } ?>>
                            ...
                            <div class="form-group row">
                                <label for="name"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('CMND/CCCD') }}</label>
                                <div class="col-md-8">
                                    <input id="name" type="text"
                                        class="form-control @error('cert_id') is-invalid @enderror" name="cert_id"
                                        value="{{ old('cert_id', !empty($user) ? $user->cert_id : '') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Mã giới thiệu') }}</label>
                                <div class="col-md-8">
                                    <input id="name" type="text"
                                        class="form-control @error('refcode') is-invalid @enderror" name="refcode"
                                        value="{{ old('refcode', !empty($user) ? $user->refcode : '') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Số điện thoại') }}</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label for="address"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Address') }}</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label for="phone"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Avatar') }}</label>
                                <div class="col-md-4">
    ...
    @endif -->
                            ...
                            <div class="form-group row">
                                <label for="phone"
                                    class="col-md-3 col-form-label text-md-right text-start">{{ __('Banner') }}</label>
                                <div class="col-md-4">
                                    ...
                                    <div class="p-3 tab-pane fade {{ $locale == App\Models\I18nContent::DEFAULT ? 'show active' : '' }}"
                                        ...
                                        <div class="form-group row">
                                            <label for="introduce"
                                                ...
                                                [{{ $locale }}]</label>
                                            <div class="col-md-8">
                                                <textarea name="introduce[{{ $locale }}]" class="form-control">{!! old('introduce', !empty($user) ? $user->introduce : '') !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="editor"
                                                ...
                                                [{{ $locale }}]</label>
                                            <div class="col-md-8">
                                                <textarea class="form-control" id="editor{{ $locale }}" name="full_content[{{ $locale }}]">{!! old('full_content', !empty($user) ? $user->full_content : '') !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
