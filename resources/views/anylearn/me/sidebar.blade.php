...
<ul class="navbar-nav sidebar sidebar-dark accordion d-print-none shadow rounded me-4 pt-4"
    style="background-color: #00a551" id="accordionSidebar">
    @if (Auth::user()->role == 'school' || Auth::user()->role == 'teacher')
        ...
        <li
            ...
            <div class="collapse {{ in_array($route, [ 'me.transactionhistory', 'me.class', 'me.class.create', 'me.class.edit', 'me.introduce', 'me.work']) ? 'show' : '' }}"
                ...
                <div class="bg-gray-300 py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item {{ in_array($route, ['me.work']) ? 'active' : '' }}"
                        href="{{ route('me.work') }}">
        ...
        <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#HDCN-collapse" aria-expanded="false">
            ...
            <span>@lang('HỢP ĐỒNG/CHI NHÁNH')</span>
        </a>
        <div class="collapse {{ in_array($route, ['location', 'location.create', 'location.edit', 'me.contract']) ? 'show' : '' }}"
            id="HDCN-collapse" style="">
            <div class="bg-gray-300 py-2 collapse-inner rounded">
        ...
        <li class="nav-item {{ in_array($route, ['me.withdraw']) ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('me.withdraw') }}" data-spm="nav.class">
                <i class="fas fa-user-shield"></i>
                <span>@lang('GIAO DỊCH/RÚT TIỀN')</span></a>
        </li>
    ...
    <li class="nav-item {{ in_array($route, ['me.resetpassword']) ? 'active' : '' }}">
        ...
        <div class="collapse {{ in_array($route, ['me.resetpassword']) ? 'show' : '' }}" id="order-collapse"
            style="">
            <div class="bg-gray-300 py-2 collapse-inner rounded">
                <a class="collapse-item {{ in_array($route, ['me.resetpassword']) ? 'active' : '' }}"
                    href="{{ route('me.resetpassword') }}">
