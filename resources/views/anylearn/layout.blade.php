...
<body data-spm="@yield('spmb')">
    <section>
        ...
        <section class="container">
            <p class="m-2 p-2 bg-primary text-danger"><i class="fas fa-exclamation-triangle"></i>@lang('Chào ' . @auth()->user()->name . '. Bạn có đơn hàng đang chờ thanh toán.') <a href="{{ route('me.pendingorders') }}" class="text-danger strong">@lang('Thanh toán ngay!')</a></p>
        </section>
        @endif
        @endif
