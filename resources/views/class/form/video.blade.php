            ...
            <div class="g-0 justify-content-between row">
                ...
                <div class=" mb-md-0 col-md-auto">
                    <div class="g-3 gy-md-0 h-100 align-items-center row">
                        <button type="button" onclick="addid({{ $chap->chapter_no }})" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal2">Thêm
                            bài mới</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="form-floating">
                                <label style="opacity:.9;" for="floatingTextarea2">Giới Thiệu ngắn</label>
