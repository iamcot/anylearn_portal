                        ...
                        <div class="layout one-col stack"
                            ...
                            <div class="layout__inner" style="border-collapse:collapse;display:table;width:100%">
                                <div class="column"
                                    ...
                                    <div style="Margin-left:20px;Margin-right:20px;display:flex;justify-content:center;align-items:center"></span>
                                        ...
                                        <span style="display:flex;align-items:center"><span><img src="{{ url('/cdn/img/MoMoLogo.png') }}" width="35"></span>
                                   </div>
                                    <div style="Margin-left:20px;Margin-right:20px">
                                        <div style="vertical-align:middle">
                                            <p class="size-11"
