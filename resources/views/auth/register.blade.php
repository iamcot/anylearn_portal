    ...
    <div class="row justify-content-center">
        <div class="col-md-8" style="padding-top:80px;">
            <div class="card shadow">
                <div class="card-header m-0 font-weight-bold text-{{ env('MAIN_COLOR', 'primary') }}"><i class="fas fa-gift"></i> {{ __('Đăng ký tham gia') }} {{ env('APP_NAME') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref" type="text" class="form-control @error('ref') is-invalid @enderror" name="ref" value="{{ old('ref') }}" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">{{ __('Quốc tịch') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Loại thành viên') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="offset-md-2">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="toc">@lang('Tôi đã đọc và đồng ý với <a href="{{ dd(route('guide', ['p' => 'guide_toc'])) }}" id="toc-action" data-url=":url">Điều khoản sử dụng</a>', ['url' => route('ajax.toc')])</label>
                                </div>
                            </div>
                        </div>
