                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="progress_outer">
                                    <h3 class="small_heading_navy raleway default_small_heading navy_blue h3_pink font_400">Chuyên gia đầu ngành</h3>
                            ...
                            <div class="col-md-12">
                                <div class="progress_outer">
                                    <h3 class="small_heading_navy default_small_heading navy_blue raleway font_400">Giảng viên lâu năm</h3>
                                    <div class="progress progress_bar bg_white">
                            ...
                            <div class="col-md-12">
                                <div class="progress_outer">
                                    <h3 class="small_heading_navy default_small_heading navy_blue raleway font_400">Diễn giả nổi tiếng, người thành công</h3>
                                    <div class="progress progress_bar bg_white">
                            ...
                            <div class="col-md-12">
                                <div class="progress_outer">
                                    <h3 class="small_heading_navy default_small_heading navy_blue raleway font_400">Giảng viên có bằng cấp</h3>
                                    <div class="progress progress_bar bg_white">
