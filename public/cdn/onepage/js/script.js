...
$(window).on('scroll', function () {
    if ($(window).scrollTop() > 70) { // Set position from top to add class
        ...
        $('.navbar .navbar-brand.yellow_logo_crypto> img').attr('src', '/cdn/onepage/images/logo_dark_crypto.png');
        $('.navbar .navbar-brand.yellow_logo> img').attr('src', '/cdn/onepage/images/logo-yellow-dark.png');

        $('.index-light .navbar .navbar-brand> img').attr('src', '/cdn/onepage/images/logo-dark.png');
        $('.index-light .navbar .navbar-brand.green_logo> img').attr('src', '/cdn/onepage/images/logo-green-dark.png');
        $('.index-light .navbar .navbar-brand.yellow_logo> img').attr('src', '/cdn/onepage/images/logo-yellow-dark.png');
        $('.index-light .navbar .navbar-brand.pink_logo> img').attr('src', '/cdn/onepage/images/logo-pink-dark.png');
        $('.index-light .navbar .navbar-brand.orange_logo> img').attr('src', '/cdn/onepage/images/logo-orange-dark.png');

        $('.active-navbar .navbar .navbar-brand> img').attr('src', '/cdn/onepage/images/logo-dark.png');
        $('.active-navbar .navbar .navbar-brand.green_logo> img').attr('src', '/cdn/onepage/images/logo-green-dark.png');
        $('.active-navbar .navbar .navbar-brand.pink_logo> img').attr('src', '/cdn/onepage/images/logo-pink-dark.png');
        $('.active-navbar .navbar .navbar-brand.orange_logo> img').attr('src', '/cdn/onepage/images/logo-orange-dark.png');
        $('.active-navbar .navbar .navbar-brand.yellow_logo> img').attr('src', '/cdn/onepage/images/logo-yellow-dark.png');
        ...
        $('.navbar .navbar-brand.yellow_logo> img').attr('src', '/cdn/onepage/images/logo-yellow.png');
