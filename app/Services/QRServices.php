...
class QRServices
{
    ...
    function __construct($bank = "ACB")
    {
        if ($bank == "ACB") {
            $this->str1 = self::ACBSTR1;
            $this->str2 = self::ACBSTR2;
            $this->content = self::ACBCONTENT;
        }
    }
    ...
    public function QR($money, $orderId)
    {
        if (empty($this->str1 || empty($this->str2))) {
            throw new Exception("NO_CONFIG_FOUND");
        }
    ...
    public function calCRC($str)
    {
        return $this->CRC16($str);
    }
